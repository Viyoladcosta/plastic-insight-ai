          ...
          <div className="flex-1 relative animate-scale-in" style={{ animationDelay: "0.3s" }}>
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <div className="glass-card rounded-3xl p-8 border border-border/50">
                <div className="aspect-square rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center relative overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-32 h-32 rounded-full border-4 border-primary/30 animate-ping" style={{ animationDuration: "3s" }} />
                  </div>
                  <div className="relative z-10 text-center">
                    <Scan className="w-16 h-16 text-primary mx-auto mb-4 animate-float" />
                    <p className="text-sm font-medium text-muted-foreground">Drop image to analyze</p>
                  </div>
                </div>
                ...
                <div className="mt-6 space-y-3">
                  <div className="flex items-center justify-between p-3 rounded-xl bg-secondary/50">
                    <span className="text-sm font-medium">PET (Type 1)</span>
                    <span className="text-xs px-2 py-1 rounded-full bg-accent text-accent-foreground">Recyclable</span>
                  </div>
                  <div className="flex items-center justify-between p-3 rounded-xl bg-secondary/50">
                    <span className="text-sm font-medium">Confidence</span>
                    <span className="text-sm font-bold text-primary">97.3%</span>
                  </div>
                </div>
              </div>
